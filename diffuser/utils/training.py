...
class Trainer(object):
    def __init__(
        ...
        if train_test_split == 1:
            ...
            self.dataloader = cycle(torch.utils.data.DataLoader(
                train_dataset, batch_size=train_batch_size, num_workers=0, shuffle=True, pin_memory=True
            ))
            self.test_dataloader = cycle(torch.utils.data.DataLoader(
                test_dataset, batch_size=train_batch_size, num_workers=0, shuffle=True, pin_memory=True
            ))
